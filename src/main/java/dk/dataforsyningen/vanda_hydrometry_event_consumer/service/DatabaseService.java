...
public class DatabaseService {
  ...
  public Measurement updateMeasurementFromEvent(EventModel event) {
    ...
    if (!delayed) {
      ...
      if (nr == 0) {
        logger.warn(
            "Update on nonexistent measurement " + measurement + ". Measurement inserted as new!");
      }
  ...
  public Measurement deleteMeasurementFromEvent(EventModel event) {
    ...
    if (nr == 0) {
      logger.warn(
          "Delete of nonexistent measurement (examinationType=" + event.getExaminationTypeSc() +
  ...
  public int countMeasurementHistory(String stationId, int measurementPointNumber,
    ...
    return measurementDao.countHistory(stationId, measurementPointNumber, examinationTypeSc,
        measurementDatetime);
  }
}
